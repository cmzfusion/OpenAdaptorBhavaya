...
class FastGradientPaintContext implements PaintContext {
    ...
    private class GradientInfo {
        ...
        public boolean equals(Object o) {
            ...
            if (gi.model.equals(model) && gi.parallelLength == parallelLength && gi.startColor == startColor && gi.endColor == endColor && gi.isVertical == isVertical)
                return true;
            return false;
        }
...
//			raster = null;
    ...
    FastGradientPaintContext(ColorModel cm, Rectangle r, int sc, int ec, boolean ver) {
        ...
        if (o != null) {
            ...
            //System.out.priHntln( "Storing gradient in cache. Info: " + info.toString() );
        }
    }
