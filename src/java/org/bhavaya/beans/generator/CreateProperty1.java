...
public class CreateProperty1 implements ByteCodePropertyGenerator {
    ...
    public void gen2(ClassGen _cg, Type propertyType, String propertyTypeName, String propertyName, String indexName) {
        ...
        il.append(_factory.createInvoke(_superclassName, "set" + Utilities.capitalise(propertyName), Type.VOID, new Type[]{propertyType}, Constants.INVOKESPECIAL));
