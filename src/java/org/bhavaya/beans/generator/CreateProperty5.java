...
public class CreateProperty5 implements ByteCodePropertyGenerator {
    ...
    public void gen3(ClassGen _cg, Type propertyType, String propertyTypeName, String propertyName, String indexName) {
        ...
        il.append(_factory.createInvoke(_superclassName, "set" + Utilities.capitalise(propertyName) + "Collection", Type.VOID, new Type[]{new ObjectType("org.bhavaya.collection.BeanCollection")}, Constants.INVOKESPECIAL));
