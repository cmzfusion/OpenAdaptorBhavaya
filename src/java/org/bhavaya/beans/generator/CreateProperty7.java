...
public class CreateProperty7 implements ByteCodePropertyGenerator {
    ...
    public void gen3(ClassGen _cg, Type propertyType, String propertyTypeName, String propertyName, String indexName) {
        ...
        InstructionHandle ih_84 = il.append(_factory.createLoad(Type.INT, 2));
        BranchInstruction ifne_85 = _factory.createBranchInstruction(Constants.IFNE, null);
        il.append(ifne_85);
        il.append(_factory.createLoad(Type.OBJECT, 0));
        ...
        InstructionHandle ih_94 = il.append(_factory.createLoad(Type.OBJECT, 0));
        il.append(_factory.createLoad(Type.OBJECT, 1));
        il.append(_factory.createFieldAccess(_className, propertyName + "Collection", new ObjectType("org.bhavaya.collection.BeanCollection"), Constants.PUTFIELD));
        InstructionHandle ih_99 = il.append(_factory.createLoad(Type.INT, 4));
        BranchInstruction ifne_101 = _factory.createBranchInstruction(Constants.IFNE, null);
        il.append(ifne_101);
        il.append(_factory.createLoad(Type.INT, 2));
        BranchInstruction ifne_105 = _factory.createBranchInstruction(Constants.IFNE, null);
        il.append(ifne_105);
        il.append(_factory.createLoad(Type.OBJECT, 0));
        ...
        InstructionHandle ih_118 = il.append(_factory.createReturn(Type.VOID));
        ...
        ifeq_74.setTarget(ih_84);
        ifne_85.setTarget(ih_94);
        ifne_101.setTarget(ih_118);
        ifne_105.setTarget(ih_118);
        method.setMaxStack();
        method.setMaxLocals();
        _cg.addMethod(method.getMethod());
        il.dispose();
